...
echo "Uploading Solaris 0.3.2 build 8: quality settings and WebRTC checker fix"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Add selectable quality presets and fix WebRTC checker false positive (build 8)"
