...
echo "Uploading Solaris 0.3.2 build 22: H264 VideoToolbox hardware encoder route"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Prefer H264 VideoToolbox for stable screen encoding (build22)"
