...
echo "Uploading Solaris 0.3.2 build 21: corrected browser integration test and audited sender"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Fix adaptive-resolution browser test and audit screen sender (build21)"
