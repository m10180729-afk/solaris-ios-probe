...
echo "Uploading Solaris 0.3.2 build 18: sender encoder policy and exact artifact names"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Configure screen-cast sender to preserve native quality"
