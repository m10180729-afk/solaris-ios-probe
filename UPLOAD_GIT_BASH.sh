...
echo "Uploading Solaris 0.3.2 build 29: WebRTC-native app-audio buffering (no microphone)"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Use WebRTC native audio buffering and align A/V playout (build29)"
