...
echo "Uploading Solaris 0.3.2 build 19: H264, nonblocking capture, and RTP diagnostics"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Improve native screen FPS with H264 and bounded capture"
