...
echo "Uploading Solaris 0.3.2 build 31: Windows 1080p120 sender and iPad/Windows receiver"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Add Windows 1080p120 screen sharing to iPad and Windows (build31)"
