...
echo "Uploading Solaris 0.3.2 build 17: stable native quality and exact artifact names"
...
if git diff --cached --quiet; then
  ...
  git commit -m "Stabilize native screen quality and name build17 artifacts"
