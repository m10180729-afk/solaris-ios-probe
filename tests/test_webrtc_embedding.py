...
class EmbeddingTests(unittest.TestCase):
    ...
    def test_desktop_audio_is_output_only(self):
        ...
        device = (root / "ios/App/SolarisPlaybackAudioDevice.m").read_text()
        self.assertIn("audioDevice: playbackDevice", receiver)
        self.assertIn("kAudioUnitSubType_RemoteIO", device)
        self.assertNotIn("kAudioUnitSubType_VoiceProcessingIO", device)
        self.assertIn("kAudioUnitScope_Input, 1, &disabled", device)
