...
test('missing codec API keeps browser defaults and starts normally',async()=>{
...
test('connected H264 with zero frames triggers exactly one same-session recovery',async()=>{
  ...
  s.senderDiagnostic={build:'20',framesSubmitted:60};
...
test('quality is saved and acknowledged by request ID, not merely by local selection',async()=>{
  ...
  const diagnostic={version:'0.3.2',build:'20',sessionID:s.id,qualityID:'720p30',targetFPS:30};
