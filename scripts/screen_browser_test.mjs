      ...
      if(row.kind==='offer') {
        const results=await sender.evaluate(async envelope=>{
          ...
          peer.ondatachannel=e=>{
            const dc=e.channel;
            dc.onopen=()=>dc.send(JSON.stringify({version:'0.3.2',build:'24',sessionID:envelope.sessionID,
            ...
            dc.onmessage=async event=>{
              ...
              draw();
              dc.send(JSON.stringify({version:'0.3.2',build:'24',sessionID:envelope.sessionID,
