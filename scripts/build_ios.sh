...
SOLARIS_OUTPUT="$SOLARIS_ROOT/dist/Solaris-0.3.2-build34-resign.ipa"
...
cp ios/App/Resources/solaris-p2p.html dist/Solaris-Windows-0.3.2-build34.html
cp ios/App/Resources/solaris-desktop.html dist/Solaris-Desktop-Share-build34.html
