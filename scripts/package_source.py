...
OUTPUT = ROOT.parent / "Solaris-0.3.2-build31-windows-1080p120-source.zip"
...
with zipfile.ZipFile(OUTPUT, "w", zipfile.ZIP_DEFLATED) as archive:
    ...
    archive.write(ROOT / "ios/App/Resources/solaris-p2p.html", "Solaris-Windows-0.3.2-build31.html")
    archive.write(ROOT / "ios/App/Resources/solaris-desktop.html", "Solaris-Desktop-Share-build31.html")
...
receiver = ROOT.parent / "Solaris-Windows-0.3.2-build31.html"
receiver.write_bytes((ROOT / "ios/App/Resources/solaris-p2p.html").read_bytes())
print(f"Windows receiver: {receiver}")
desktop = ROOT.parent / "Solaris-Desktop-Share-build31.html"
