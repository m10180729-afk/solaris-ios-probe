...
OUTPUT = ROOT.parent / "Solaris-0.3.2-build29-webrtc-native-audio-buffer-source.zip"
...
with zipfile.ZipFile(OUTPUT, "w", zipfile.ZIP_DEFLATED) as archive:
    ...
    archive.write(ROOT / "ios/App/Resources/solaris-p2p.html", "Solaris-Windows-0.3.2-build29.html")
...
receiver = ROOT.parent / "Solaris-Windows-0.3.2-build29.html"
