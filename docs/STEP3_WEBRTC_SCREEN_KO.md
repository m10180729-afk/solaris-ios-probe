...
4. 성공한 실행의 Solaris-0.3.2-build19-app-and-receiver 아티팩트를 다운로드합니다.
5. 압축을 푼 SolarisProbe-resign.ipa를 AltStore로 재서명·설치합니다. 확장을 제거하지 마세요.
6. iPad 첫 화면이 **0.3.2 (build 19)**인지 확인합니다.
...
실패한 실행에서 **Solaris-build19-xcode-evidence** 아티팩트를 받아 전달하면
