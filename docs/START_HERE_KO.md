...
Windows에서 ZIP을 `Downloads/Solaris-0.3.1` 폴더에 풀었다면:

```bash
cd ~/Downloads/Solaris-0.3.1
...
성공 기록의 Artifacts에서 `Solaris-0.3.1-app-and-receiver`를 받습니다.
압축 안 `SolarisProbe-resign.ipa`를 AltStore로 설치하고, 앱에 0.3.1이 표시되는지 확인하세요.
