...
- `Solaris-Desktop-Share-build31.html`에 Windows H.264 화면 송신과 다른 Windows 수신을 함께 추가.
...
Solaris-0.3.2-build31-bidirectional-screen을 다운로드합니다.
Solaris-0.3.2-build31-resign.ipa, Solaris-Windows-0.3.2-build31.html,
Solaris-Desktop-Share-build31.html을 함께 사용합니다.
