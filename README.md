...
- IPA·HTML·아티팩트·앱 build 번호를 모두 30으로 통일.

## 설치

소스를 압축 해제하고 해당 폴더에서 Git Bash로 bash UPLOAD_GIT_BASH.sh를 실행합니다.
GitHub Actions의 browser-test와 build 모두 성공 후
Solaris-0.3.2-build30-app-and-receiver를 다운로드합니다.
Solaris-0.3.2-build30-resign.ipa와 Solaris-Windows-0.3.2-build30.html을 함께 사용합니다.
